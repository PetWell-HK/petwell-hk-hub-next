...
const cover = "/assets/blog-mid-autumn-pet-hk/cover.jpg";
...
export const blogPostsMidAutumn: BlogPost[] = [
  {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          "9 月 25 日（星期五）16:00–20:00 人流通常較少，適合怕嘈的毛孩；9 月 26–27 日（星期六、日）15:00–21:00 氣氛最熱鬧，適合打卡及逛夜市。賞月建議日落後到場。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "短牽繩（建議 1.5 米以內）、清水及摺疊碗、尿墊、濕紙巾、毛巾及少量零食。如怕人多，可攜帶外出袋或寵物推車。現場天燈為寵物友善 LED 款式，無需自備明火燈籠。",
      },
      {
        question: "入場需要預約嗎？",
        answer:
          "免費入場，無需預約，歡迎所有動物參加。如想獲贈全家福 soft copy 一張，可先行預約。養生花膠月餅工作坊不設即場體驗，必須預先報名。",
      },
    ],
    content: `
      <p style="font-size: 13px; color: #666; margin-bottom: 20px; letter-spacing: 0.4px;">最後更新：2026 年 8 月 29 日　｜　2026 中秋：9 月 25 日（星期五）</p>
      ...
      <div style="display:grid;gap:8px;font-size:15px;">
          ...
          <a href="#sixty-seconds" style="color:#C2410C;text-decoration:none;">2. 出發前 6 個重點</a>
          <a href="#practical" style="color:#C2410C;text-decoration:none;">3. 日期、時間、地圖與交通</a>
          <a href="#checklist" style="color:#C2410C;text-decoration:none;">4. 帶毛孩出門要準備甚麼？</a>
      ...
      <p style="font-size:17px;line-height:1.85;margin-bottom:20px;">2026 年 9 月 25–27 日，同一條海濱將加設 PetWell × AquaBeat「毛孩沉浸台式中秋節」：天燈、十分車站／九份打卡、養生花膠月餅、美人魚表演，以及和服／新中式服裝租借。換句話說，<strong>只要走到海濱，便已同時賞月、過節、打卡。</strong></p>

<h2 id="sixty-seconds" style="font-size:26px;font-weight:700;margin:40px 0 18px;padding-bottom:10px;border-bottom:2px solid #FF6B35;scroll-margin-top:88px;">出發前 6 個重點</h2>

      <ul style="list-style:none;padding:0;margin:0 0 14px;font-size:15px;line-height:1.7;">
        <li style="display:flex;gap:10px;padding:9px 0;border-bottom:1px solid #FED7AA;"><span aria-hidden="true">🐾</span><span><strong style="color:#9A3412;">所有動物均歡迎參加：</strong>怕嘈或高齡毛孩，建議於星期五黃昏到場，人流較少。</span></li>
        <li style="display:flex;gap:10px;padding:9px 0;border-bottom:1px solid #FED7AA;"><span aria-hidden="true">🦮</span><span><strong style="color:#9A3412;">牽繩／推車：</strong>建議使用 1.5 米以內的短牽繩；人多時可使用外出袋或寵物推車。</span></li>
        ...
        <li style="display:flex;gap:10px;padding:9px 0;"><span aria-hidden="true">🎟️</span><span><strong style="color:#9A3412;">入場：</strong>免費入場，無需預約；預約可獲贈全家福 soft copy 一張。</span></li>
      </ul>
      <p style="font-size:13px;color:#6B7280;margin:0 0 28px;">最後更新：2026 年 8 月 29 日　·　免費入場，無需預約　·　花膠月餅工作坊須預先報名</p>
      ...
      <figure style="margin:0 0 28px;">
        <img src="${lanterns}" alt="觀塘海濱寵物友善 LED 天燈：兩隻小狗與主人一同賞月" style="width:100%;border-radius:12px;" width="1600" height="900" loading="lazy" />
        <figcaption style="font-size:13px;color:#6B7280;margin-top:8px;">現場採用寵物友善 LED 天燈，無需明火，毛孩靠近亦更安心。</figcaption>
      </figure>
      ...
      <figure style="margin:0 0 28px;">
        <img src="${taiwanSpots}" alt="寵物中秋打卡示意：狗與貓在寵物尺寸夜市攤檔扮演檔主，設有大腸包小腸及臭豆腐攤檔" style="width:100%;border-radius:12px;" width="1600" height="900" loading="lazy" />
        <figcaption style="font-size:13px;color:#6B7280;margin-top:8px;">示意圖：寵物尺寸夜市攤檔（大腸包小腸、臭豆腐），毛孩可以扮演檔主拍照。</figcaption>
      </figure>

      <h3 id="taiwan" style="font-size:21px;font-weight:700;margin:28px 0 12px;scroll-margin-top:88px;">4. 台式沉浸體驗：許願天燈、美人魚表演</h3>
      <p style="font-size:16px;line-height:1.85;margin-bottom:16px;">活動全名為「毛孩沉浸台式中秋節」，並非只掛上幾盞燈飾。現場設有：</p>
      ...
      <figure style="margin:0 0 24px;">
        <img src="${mermaid}" alt="美人魚表演示意：穿著和服的小狗站在水缸前，與缸內的美人魚揮手打招呼" style="width:100%;border-radius:12px;" width="1600" height="900" loading="lazy" />
        <figcaption style="font-size:13px;color:#6B7280;margin-top:8px;">示意圖：美人魚表演，毛孩可以在缸邊近距離欣賞。</figcaption>
      </figure>
      <p style="font-size:16px;line-height:1.85;margin-bottom:24px;">怕嘈的貓或高齡犬，建議星期五黃昏先到場，繞天燈區及打卡位一圈便可離開；精力旺盛的狗則可以留到星期六晚上，盡情享受天燈與夜市攤檔的氣氛。</p>
      ...
      <p style="font-size:13px;color:#6B7280;margin:0 0 24px;">圖片來源：<a href="${DRESS_URL}" target="_blank" rel="noopener noreferrer" style="color:#FF6B35;">D&amp;L² pawradise</a>。尺碼 XXS–XL，出發前可對照胸圍／背長／頸圍。</p>

      <figure style="margin:0 0 32px;">
        <img src="${cover}" alt="觀塘海濱寵物中秋打卡：穿新中式珍珠流蘇裙的小狗坐在木板步道，背景是維港圓月與燈籠" style="width:100%;border-radius:12px;" width="1600" height="900" loading="lazy" />
        <figcaption style="font-size:13px;color:#6B7280;margin-top:8px;">海濱圓月配上新中式裙，正是今年最想帶回家的一張中秋照。</figcaption>
      </figure>

      <h2 id="practical" style="font-size:26px;font-weight:700;margin:40px 0 18px;padding-bottom:10px;border-bottom:2px solid #FF6B35;scroll-margin-top:88px;">出發前：交通、裝備與毛孩舒適提示</h2>
      ...
      <p style="font-size:16px;line-height:1.85;margin:0 0 16px;">活動場地附近設有停車場，日泊收費只需 $50，相當相宜。<span style="font-size:13px;color:#6B7280;">（價格以停車場當日公布為準）</span></p>
      ...
      <div style="background:#FFF7ED;border-left:4px solid #FF6B35;border-radius:12px;padding:18px 20px;margin:0 0 24px;">
        <p style="margin:0 0 10px;font-size:15px;font-weight:700;color:#9A3412;">🐶 毛孩舒適提示</p>
        <ul style="margin:0;padding-left:20px;font-size:15px;line-height:1.8;color:#4B5563;">
          <li>星期六、日晚上人流及聲量較大，怕嘈的毛孩建議於星期五黃昏到場。</li>
          <li>自備清水及摺疊碗，定時為毛孩補水；九月下旬的黃昏仍然偏熱。</li>
          <li>全程使用 1.5 米以內的短牽繩，避免在夜市檔口前長時間停留。</li>
          <li>打卡位或需排隊，輪候時請在陰涼處等候。</li>
          <li>如毛孩開始喘氣、躲避人群或不願前行，應帶牠離開人群，到海濱休息片刻。</li>
        </ul>
      </div>

      <h3 id="checklist" style="font-size:20px;font-weight:700;margin:24px 0 12px;scroll-margin-top:88px;">出門清單</h3>
      <ul style="font-size:16px;line-height:1.9;margin:0 0 20px;padding-left:22px;">
        <li>1.5 米以內牽繩、外出袋或寵物推車（人多時使用）</li>
        <li>清水、摺疊碗、尿墊、濕紙巾、毛巾</li>
        <li>少量毛孩熟悉的零食；切勿攜帶人類月餅分享</li>
        <li>星期五賞月、週末打卡逛夜市——行程可分兩天進行，無需一次完成</li>
      </ul>
      ...
      <div id="rsvp" style="overflow:hidden;background:#ffffff;border:1px solid #E7E5E4;border-radius:16px;margin-bottom:8px;scroll-margin-top:88px;">
        ...
        <div style="padding:20px 20px 22px;background:#ffffff;">
          ...
          <p style="margin:0 0 14px;font-size:22px;font-weight:800;line-height:1.3;color:#1C1917 !important;">毛孩沉浸台式中秋節</p>
          ...
          <p style="margin:0 0 18px;font-size:14px;line-height:1.75;color:#44403C !important;">帶同毛孩即可即場入場。賞月、十分／九份打卡、LED 天燈、美人魚表演、服裝租借一應俱全。花膠月餅工作坊須預先報名；預約可獲贈全家福 soft copy。</p>
          <div style="display:flex;flex-wrap:wrap;gap:10px;">
            <button type="button" onclick="window.dispatchEvent(new CustomEvent('petwell:open-contact',{detail:{topic:'family-photo'}}))" style="cursor:pointer;border:0;background:#FF6B35;color:#ffffff;font-weight:800;padding:11px 18px;border-radius:10px;">預約送全家福</button>
          ...
          <p style="margin:16px 0 0;font-size:13px;line-height:1.6;color:#78716C !important;">檔主、傳媒或品牌請於 <a href="/vendor-application" style="color:#C2410C !important;font-weight:700;text-decoration:underline;">開檔申請</a>。免費入場，無需預約 · 最後更新：2026 年 8 月 29 日</p>
        </div>
      </div>
    `,
  },
